...
<?php
  ...
  $Q1 = $_POST['Q1'];
  $CA = $_POST['CA'];
  $new_KeyboardNo = $_POST['KeyboardNo'];
  $classification = $_POST['classification'];

  $sql = "SELECT * FROM QuestionList WHERE No = '$question_number' AND QA = 'Q'";
  $result = mysqli_fetch_object($db->query($sql));

  /*echo $new_KeyboardNo.'<br />';
  echo $Q1.'<BR />';
  echo $CA.'<br />';
  echo $classification[0];*/

  //UPDATE QUESTIONLIST DB
  $sqlQuestion = "UPDATE QuestionList SET CA = '$CA', Content = '$Q1', classification='$classification[0]',KeyboardNo='$new_KeyboardNo' WHERE No='$question_number'";
