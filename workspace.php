      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
            ...
            <div class="x_panel">
                ...
                <!-- Question List Table -->
                <table id="q_list" class="table table-striped table-bordered" style="width:100%">
                  <thead>
                    <tr>
                      <th>題號.</th>
                      <th>文字/圖片</th>
        ...
        <!-- /footer content -->
			...
			<script src="../vendors/Editor-1.9.0/js/dataTables.editor.min.js"></script>
