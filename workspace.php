            ...
            <div class="x_panel">
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="setKeyboard">
                            <form class="form-horizontal form-label-left" method="post" action="workspace1.php" enctype="multipart/form-data" onKeyDown="if (event.keyCode == 13) {return false;}">
                            ...
                            <div class="form-group">
                                ...
                                <button class="btn btn-success" onclick="setKeyboardType('D');return false;">6*4</button></button>
                            </div>
