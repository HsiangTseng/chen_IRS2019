                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="singel-word-tab">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text"  name="A1"  class="form-control col-md-7 col-xs-12">
                                </div>
                                <label class="control-label col-md-1" for="last-name">附加音檔: <span></span></label>
                                <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text"  name="A2"  class="form-control col-md-7 col-xs-12">
                                </div>
                                <label class="control-label col-md-1" for="last-name">附加音檔: <span></span></label>
                                <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text"  name="A3"  class="form-control col-md-7 col-xs-12">
                                </div>
                                <label class="control-label col-md-1" for="last-name">附加音檔: <span></span></label>
                                <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text"  name="A4"  class="form-control col-md-7 col-xs-12">
                                </div>
                                <label class="control-label col-md-1" for="last-name">附加音檔: <span></span></label>
                                <div class="col-md-3">
