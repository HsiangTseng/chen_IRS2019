      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
            ...
            <div class="x_panel">
                ...
                <form class="form-horizontal form-label-left" method="post" action="updateEdit_video.php" enctype="multipart/form-data" onKeyDown="if (event.keyCode == 13) {return false;}">
                  ...
                  <div  class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3" for="last-name">上傳影片 <span></span></label>
                        <div class="col-md-5">
            ...
            {
              echo '<script>single_video();</script>';
            ...
            {
              echo '<script>multi_video();</script>';
