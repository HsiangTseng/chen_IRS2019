      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
            ...
            <div class="x_panel">
                ...
                <!-- MakeOut Form -->
                <form class="form-horizontal form-label-left" method="post" action="updateExam.php" onKeyDown="if (event.keyCode == 13) {return false;}">
                    <div class="form-group">
                        <label class="control-label col-md-3" for="first-name">測驗卷編號 : </label>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3" for="first-name">測驗卷名稱 :<span class="required"></span></label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3" for="last-name">測驗說明(可不填) :<span></span></label>
                        <div class="col-md-5">
                          <input type="text"  name="exam_note" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3" for="last-name">出題老師 :<span class="required"></span></label>
                        <div class="col-md-5">
                          <input type="text"  name="exam_teacher" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
